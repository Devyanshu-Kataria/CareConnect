                        ...
                        <form onSubmit={submitHandler}>
                            ...
                            <div className="mb-5 relative">
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="w-full pr-20 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer"
                                    required
                                />
                                <button
                                    type="button"
                                    onClick={toggleShowPassword}
                                    className="absolute right-2 top-1/2 transform -translate-y-1/2 text-sm text-primaryColor"
                                >
