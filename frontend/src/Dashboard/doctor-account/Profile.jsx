...
const Profile = ({ doctorData }) => {
  ...
  const handleFileInputChange = async event => {
    ...
    try {
        ...
        if (uploadResult) {
            setFormData({ ...formData, photo: uploadResult });
            
            // Update doctor photo in the backend
        ...
        setFormData({ ...formData, photo: doctorData?.photo || null });
    }
  };
    ...
    <div>
      ...
      <form>
        ...
        <div className="mb-5">
          ...
          <div className="mt-5">
            <button className="form_btn" onClick={addQualification} style={buttonStyle}>
              Add Qualification
            </button>
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <div className="mt-5">
            <button className="form_btn" onClick={addExperience} style={buttonStyle}>
              Add Experience
            </button>
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <div className="mt-5">
            <button className="form_btn" onClick={addTimeSlot} style={buttonStyle}>
              Add Time Slot
            </button>
          </div>
        </div>
